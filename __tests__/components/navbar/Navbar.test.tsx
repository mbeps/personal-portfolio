...
import DesktopNavbarSection from "@/components/navbar/DesktopNavbarSection";
import HomeButton from "@/components/navbar/HomeButton";
import MobileNavbarSection from "@/components/navbar/MobileNavbarSection";
...
describe("Navbar Components Suite", () => {
  ...
  describe("DesktopNavbarSection", () => {
    test("renders only items with isMain: true", () => {
      const mockItems = [
        { label: "Main Item 1", path: "/main1", isMain: true },
        { label: "Secondary Item", path: "/secondary", isMain: false },
        { label: "Main Item 2", path: "/main2", isMain: true },
      ];
