 ...
 * these are the categorised into specific skills categories such as programming languages, frameworks, DevOps, etc. represented by {@link CategorisedSkillsInterface}.
 *
 * @requires {@link CategorisedSkillsInterface} to represent the list of skills categories that are grouped together.
 */
