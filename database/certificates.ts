...
const certificateMap: Database<CertificateInterface> = {
  ...
  [CertificateKeysEnum.UdemyBecomeALinearAlgebraMaster]: {
    ...
    learningOutcomes: [
      ...
      "Solving linear systems in two unknowns",
      "Solving linear systems in three unknowns",
      "Defining matrix dimensions and entries",
      "Representing systems with matrices",
      "Performing simple row operations",
      "Identifying pivot entries and achieving row-echelon forms",
      "Applying Gauss-Jordan elimination",
      "Determining the number of solutions to the linear system",
      "Introducing operations on two matrices",
      "Adding and subtracting matrices",
      "Performing scalar multiplication",
      "Understanding zero matrices",
      "Multiplying matrices",
      "Identifying identity matrices",
      "Using the elimination matrix for transformations",
      "Introducing matrices as vectors",
      "Manipulating vectors",
      "Performing vector operations",
      "Identifying unit vectors and basis vectors",
      "Creating linear combinations and defining span",
      "Determining linear independence in two dimensions",
      "Determining linear independence in three dimensions",
      "Defining linear subspaces",
      "Exploring spans as subspaces",
      "Defining a basis for vector spaces",
      "Introducing dot products and cross products",
      "Calculating dot products",
      "Applying the Cauchy-Schwarz inequality",
      "Understanding the vector triangle inequality",
      "Calculating the angle between vectors",
      "Deriving equations of a plane and identifying normal vectors",
      "Executing cross product calculations",
      "Contrasting dot and cross products as opposite ideas",
      "Introducing matrix-vector products",
      "Multiplying matrices by vectors",
      "Exploring the null space and Ax=0",
      "Investigating the null space of a matrix",
      "Determining the column space and solving Ax=b",
      "Solving Ax=b for specific vectors",
      "Discussing dimensionality, nullity, and rank",
      "Introducing transformations",
      "Analyzing functions and transformations",
      "Utilizing transformation matrices and exploring the image of the subset",
      "Investigating preimage, image, and the kernel",
      "Applying linear transformations as matrix-vector products",
      "Implementing linear transformations as rotations",
      "Adding and scaling linear transformations",
      "Projecting as linear transformations",
      "Composing linear transformations",
      "Introducing inverses",
      "Reversing transformations to find inverses",
      "Evaluating invertibility from the matrix-vector product",
      "Confirming inverse transformations are linear",
      "Discussing matrix inverses, and differentiating between invertible and singular matrices",
      "Solving systems with inverse matrices",
      "Introducing determinants",
      "Calculating determinants",
      "Applying Cramer's rule for solving systems",
      "Modifying determinants",
      "Investigating upper and lower triangular matrices",
      "Using determinants to find area",
      "Introducing transposes",
      "Exploring transposes and their determinants",
      "Analyzing transposes of products, sums, and inverses",
      "Examining null and column spaces of the transpose",
      "Studying the product of a matrix and its transpose",
      "Performing A=LU factorization",
      "Introducing orthogonality and change of basis",
      "Finding orthogonal complements",
      "Exploring orthogonal complements of the fundamental subspaces",
      "Projecting onto the subspace",
      "Finding least squares solutions",
      "Changing coordinates in a new basis",
      "Constructing transformation matrices for a basis",
      "Introducing orthonormal bases and Gram-Schmidt",
      "Establishing orthonormal bases",
      "Projecting onto an orthonormal basis",
      "Applying the Gram-Schmidt process for change of basis",
      "Introducing eigenvalues and eigenvectors",
      "Determining eigenvalues, eigenvectors, and eigenspaces",
      "Exploring eigenvalues and eigenvectors in three dimensions",
    ],
    description: `
