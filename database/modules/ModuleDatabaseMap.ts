...
const modulesMap: Database<ModuleInterface> = {
  ...
  [ModuleDatabaseKeys.RHUL_ProgrammingLaboratory]: {
    ...
    category: ModuleYearGroupsEnum.Year1,
    skills: [SkillDatabaseKeys.Python, SkillDatabaseKeys.SimpleGui],
  ...
  [ModuleDatabaseKeys.RHUL_MathematicalStructures]: {
    ...
    category: ModuleYearGroupsEnum.Year1,
    skills: [SkillDatabaseKeys.Mathematics, SkillDatabaseKeys.Discrete],
    learningOutcomes: [
  ...
  [ModuleDatabaseKeys.RHUL_MachineFundamentals]: {
    ...
    category: ModuleYearGroupsEnum.Year1,
    skills: [SkillDatabaseKeys.Mathematics, SkillDatabaseKeys.Logics],
    learningOutcomes: [
  ...
  [ModuleDatabaseKeys.RHUL_UserCentredDesign]: {
    ...
    skills: [SkillDatabaseKeys.UserCentricDesign],
    learningOutcomes: [
  ...
  [ModuleDatabaseKeys.RHUL_FunctionalProgramming]: {
    ...
    category: ModuleYearGroupsEnum.Year3,
    skills: [SkillDatabaseKeys.Haskell, SkillDatabaseKeys.Scala],
    learningOutcomes: [
