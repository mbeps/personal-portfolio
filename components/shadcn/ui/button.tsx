...
const buttonVariants = cva(
  "inline-flex cursor-pointer items-center justify-center whitespace-nowrap font-medium font-semibold text-md transition-all duration-500 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 md:hover:bg-red-400 md:dark:hover:bg-red-950",
  {
    variants: {
      variant: {
        default: `
