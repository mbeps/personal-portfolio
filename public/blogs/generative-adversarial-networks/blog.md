...
1. Goodfellow, I. J., Pouget-Abadie, J., *et al.* (2014). [Generative Adversarial Networks](https://arxiv.org/abs/1406.2661). ([arXiv][1])

2. Radford, A., Metz, L., & Chintala, S. (2016). [Unsupervised Representation Learning with Deep Convolutional Generative Adversarial Networks](https://arxiv.org/abs/1511.06434). ([arXiv][2])

3. Arjovsky, M., Chintala, S., & Bottou, L. (2017). [Wasserstein Generative Adversarial Networks](https://arxiv.org/abs/1701.07875). ([arXiv][3])

4. Gulrajani, I., Ahmed, F., *et al.* (2017). [Improved Training of Wasserstein GANs](https://arxiv.org/abs/1704.00028). ([arXiv][4])

5. Kingma, D. P., & Welling, M. (2014). [Auto-Encoding Variational Bayes](https://arxiv.org/abs/1312.6114). ([arXiv][5])

6. van den Oord, A., Kalchbrenner, N., & Kavukcuoglu, K. (2016). [Pixel Recurrent Neural Networks](https://arxiv.org/abs/1601.06759). ([arXiv][6])

7. Karras, T., Laine, S., & Aila, T. (2019). [A Style-Based Generator Architecture for Generative Adversarial Networks](https://arxiv.org/abs/1812.04948). ([arXiv][7])

8. Karras, T., Laine, S., *et al.* (2020). [Analyzing and Improving the Image Quality of StyleGAN](https://arxiv.org/abs/1912.04958). ([arXiv][8])

9. Karras, T., Aittala, M., *et al.* (2021). [Alias-Free Generative Adversarial Networks (StyleGAN3)](https://arxiv.org/abs/2106.12423). ([arXiv][9])

10. Zhu, J.-Y., Park, T., Isola, P., & Efros, A. A. (2017). [Unpaired Image-to-Image Translation Using Cycle-Consistent Adversarial Networks](https://arxiv.org/abs/1703.10593). ([arXiv][10])

11. Ho, J., Jain, A., & Abbeel, P. (2020). [Denoising Diffusion Probabilistic Models](https://arxiv.org/abs/2006.11239). ([arXiv][11])

12. Heusel, M., Ramsauer, H., *et al.* (2017). [GANs Trained by a Two Time-Scale Update Rule Converge to a Local Nash Equilibrium](https://arxiv.org/abs/1706.08500). ([arXiv][12])

[1]: https://arxiv.org/abs/1406.2661 "Generative Adversarial Networks"
[2]: https://arxiv.org/abs/1511.06434 "Unsupervised Representation Learning with Deep Convolutional Generative Adversarial Networks"
[3]: https://arxiv.org/abs/1701.07875 "Wasserstein Generative Adversarial Networks"
[4]: https://arxiv.org/abs/1704.00028 "Improved Training of Wasserstein GANs"
[5]: https://arxiv.org/abs/1312.6114 "Auto-Encoding Variational Bayes"
[6]: https://arxiv.org/abs/1601.06759 "Pixel Recurrent Neural Networks"
[7]: https://arxiv.org/abs/1812.04948 "A Style-Based Generator Architecture for Generative Adversarial Networks"
[8]: https://arxiv.org/abs/1912.04958 "Analyzing and Improving the Image Quality of StyleGAN"
[9]: https://arxiv.org/abs/2106.12423 "Alias-Free Generative Adversarial Networks (StyleGAN3)"
[10]: https://arxiv.org/abs/1703.10593 "Unpaired Image-to-Image Translation Using Cycle-Consistent Adversarial Networks"
[11]: https://arxiv.org/abs/2006.11239 "Denoising Diffusion Probabilistic Models"
[12]: https://arxiv.org/abs/1706.08500 "GANs Trained by a Two Time-Scale Update Rule Converge to a Local Nash Equilibrium"
