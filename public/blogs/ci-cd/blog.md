...
1. Shahin, M., Babar, M. A., & Zhu, L. (2017). [Continuous Integration, Delivery and Deployment: A Systematic Review on Approaches, Tools, Challenges and Practices](https://doi.org/10.1109/ACCESS.2017.2685629). ([IEEE Access][1])

2. Saavedra, N., Mendes, A., & Ferreira, J. F. (2025). [Environmental Impact of CI/CD Pipelines](https://arxiv.org/abs/2510.26413). ([arXiv][2])

3. Xu, W., Luo, J., *et al.* (2025). [LogSage: An LLM-Based Framework for CI/CD Failure Detection and Remediation with Industrial Validation](https://arxiv.org/abs/2506.03691). ([arXiv][3])

[1]: https://doi.org/10.1109/ACCESS.2017.2685629 "Continuous Integration, Delivery and Deployment: A Systematic Review on Approaches, Tools, Challenges and Practices"
[2]: https://arxiv.org/abs/2510.26413 "Environmental Impact of CI/CD Pipelines"
[3]: https://arxiv.org/abs/2506.03691 "LogSage: An LLM-Based Framework for CI/CD Failure Detection and Remediation with Industrial Validation"
