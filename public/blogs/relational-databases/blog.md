...
1. Codd, E. F. (1970). [A Relational Model of Data for Large Shared Data Banks](https://dl.acm.org/doi/10.1145/362384.362685). ([ACM Digital Library][1])

2. Codd, E. F. (1972). [Relational Completeness of Data Base Sublanguages](https://www.inf.unibz.it/~franconi/teaching/2006/kbdb/Codd72a.pdf). ([inf.unibz.it][2])

3. Selinger, P. G., Astrahan, M. M., *et al.* (1979). [Access Path Selection in a Relational Database Management System](https://dl.acm.org/doi/10.1145/582095.582099). ([ACM Digital Library][3])

4. Bayer, R., & McCreight, E. (1972). [Organization and Maintenance of Large Ordered Indexes](https://link.springer.com/article/10.1007/BF00288683). ([SpringerLink][4])

5. O'Neil, E. J., O'Neil, P. E., & Weikum, G. (1993). [The LRU-K Page Replacement Algorithm for Database Disk Buffering](https://dl.acm.org/doi/10.1145/170035.170081). ([ACM Digital Library][5])

6. Graefe, G. (1993). [Query Evaluation Techniques for Large Databases](https://dl.acm.org/doi/10.1145/152610.152611). ([ACM Digital Library][6])

7. Poosala, V., Haas, P. J., Ioannidis, Y. E., & Shekita, E. J. (1996). [Improved Histograms for Selectivity Estimation of Range Predicates](https://dl.acm.org/doi/10.1145/233269.233342). ([ACM Digital Library][7])

8. Gray, J. N., Lorie, R. A., *et al.* (1975). [Granularity of Locks and Degrees of Consistency in a Shared Data Base](https://dl.acm.org/doi/10.5555/190956.190979). ([ACM Digital Library][8])

9. Bernstein, P. A., & Goodman, N. (1981). [Concurrency Control in Distributed Database Systems](https://dl.acm.org/doi/10.1145/356842.356846). ([ACM Digital Library][9])

10. Bernstein, P. A., Hadzilacos, V., & Goodman, N. (1983). [Multiversion Concurrency Control—Theory and Algorithms](https://www.cs.cmu.edu/~15712/papers/bernstein83.pdf). ([CMU School of Computer Science][10])

11. Berenson, H., Bernstein, P. A., *et al.* (1995). [A Critique of ANSI SQL Isolation Levels](https://dl.acm.org/doi/10.1145/223784.223785). ([ACM Digital Library][11])

12. Ports, D. R. K., & Grittner, K. (2012). [Serializable Snapshot Isolation in PostgreSQL](https://arxiv.org/abs/1208.4179). ([arXiv][12])

13. Mohan, C., Haderle, D., Lindsay, B., Pirahesh, H., & Schwarz, P. (1992). [ARIES: A Transaction Recovery Method Supporting Fine-Granularity Locking and Partial Rollbacks Using Write-Ahead Logging](https://dl.acm.org/doi/10.1145/128765.128770). ([ACM Digital Library][13])

14. Gilbert, S., & Lynch, N. (2002). [Brewer's Conjecture and the Feasibility of Consistent, Available, Partition-Tolerant Web Services](https://dl.acm.org/doi/10.1145/564585.564601). ([ACM Digital Library][14])

15. DeCandia, G., Hastorun, D., Jampani, M., *et al.* (2007). [Dynamo: Amazon's Highly Available Key-value Store](https://dl.acm.org/doi/10.1145/1323293.1294281). ([ACM Digital Library][15])

16. Chang, F., Dean, J., Ghemawat, S., *et al.* (2006). [Bigtable: A Distributed Storage System for Structured Data](https://www.usenix.org/conference/osdi-06/bigtable-distributed-storage-system-structured-data). ([USENIX][16])

17. Lakshman, A., & Malik, P. (2010). [Cassandra: A Decentralized Structured Storage System](https://dl.acm.org/doi/10.1145/1773912.1773922). ([ACM Digital Library][17])

18. Corbett, J. C., Dean, J., Epstein, M., *et al.* (2012). [Spanner: Google's Globally-Distributed Database](https://www.usenix.org/conference/osdi12/technical-sessions/presentation/corbett). ([USENIX][18])

19. Taft, R., Sharif, I., Matei, A., *et al.* (2020). [CockroachDB: The Resilient Geo-Distributed SQL Database](https://dl.acm.org/doi/10.1145/3318464.3386134). ([ACM Digital Library][19])

[1]: https://dl.acm.org/doi/10.1145/362384.362685 "A Relational Model of Data for Large Shared Data Banks"
[2]: https://www.inf.unibz.it/~franconi/teaching/2006/kbdb/Codd72a.pdf "Relational Completeness of Data Base Sublanguages"
[3]: https://dl.acm.org/doi/10.1145/582095.582099 "Access Path Selection in a Relational Database Management System"
[4]: https://link.springer.com/article/10.1007/BF00288683 "Organization and Maintenance of Large Ordered Indexes"
[5]: https://dl.acm.org/doi/10.1145/170035.170081 "The LRU-K Page Replacement Algorithm for Database Disk Buffering"
[6]: https://dl.acm.org/doi/10.1145/152610.152611 "Query Evaluation Techniques for Large Databases"
[7]: https://dl.acm.org/doi/10.1145/233269.233342 "Improved Histograms for Selectivity Estimation of Range Predicates"
[8]: https://dl.acm.org/doi/10.5555/190956.190979 "Granularity of Locks and Degrees of Consistency in a Shared Data Base"
[9]: https://dl.acm.org/doi/10.1145/356842.356846 "Concurrency Control in Distributed Database Systems"
[10]: https://www.cs.cmu.edu/~15712/papers/bernstein83.pdf "Multiversion Concurrency Control—Theory and Algorithms"
[11]: https://dl.acm.org/doi/10.1145/223784.223785 "A Critique of ANSI SQL Isolation Levels"
[12]: https://arxiv.org/abs/1208.4179 "Serializable Snapshot Isolation in PostgreSQL"
[13]: https://dl.acm.org/doi/10.1145/128765.128770 "ARIES: A Transaction Recovery Method Supporting Fine-Granularity Locking and Partial Rollbacks Using Write-Ahead Logging"
[14]: https://dl.acm.org/doi/10.1145/564585.564601 "Brewer's Conjecture and the Feasibility of Consistent, Available, Partition-Tolerant Web Services"
[15]: https://dl.acm.org/doi/10.1145/1323293.1294281 "Dynamo: Amazon's Highly Available Key-value Store"
[16]: https://www.usenix.org/conference/osdi-06/bigtable-distributed-storage-system-structured-data "Bigtable: A Distributed Storage System for Structured Data"
[17]: https://dl.acm.org/doi/10.1145/1773912.1773922 "Cassandra: A Decentralized Structured Storage System"
[18]: https://www.usenix.org/conference/osdi12/technical-sessions/presentation/corbett "Spanner: Google's Globally-Distributed Database"
[19]: https://dl.acm.org/doi/10.1145/3318464.3386134 "CockroachDB: The Resilient Geo-Distributed SQL Database"
