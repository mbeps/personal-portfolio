...
1. Alshuqayran, N., Ali, N., & Evans, R. (2016). [A Systematic Mapping Study in Microservice Architecture](https://research.brighton.ac.uk/en/publications/a-systematic-mapping-study-in-microservice-architecture/). ([Brighton Research][1])

2. Di Francesco, P., Lago, P., & Malavolta, I. (2019). [Architecting with Microservices: A Systematic Mapping Study](https://doi.org/10.1016/j.jss.2019.01.001). ([ScienceDirect][2])

3. Waseem, M., Liang, P., & Shahin, M. (2020). [A Systematic Mapping Study on Microservices Architecture in DevOps](https://doi.org/10.1016/j.jss.2020.110798). ([ScienceDirect][3])

4. Taibi, D., Lenarduzzi, V., & Pahl, C. (2018). [Architectural Patterns for Microservices: A Systematic Mapping Study](https://doi.org/10.5220/0006798302210232). ([ResearchGate][4])

5. Garriga, M. (2018). [Towards a Taxonomy of Microservices Architectures](https://doi.org/10.1007/978-3-319-74781-1_15). ([SpringerLink][5])

6. Larrucea, X., Santamaria, I., Colomo-Palacios, R., & Ebert, C. (2018). [Microservices](https://doi.org/10.1109/MS.2018.2141030). ([IEEE Software][6])

7. Auer, F., Lenarduzzi, V., Felderer, M., & Taibi, D. (2021). [From Monolithic Systems to Microservices: An Assessment Framework](https://doi.org/10.1016/j.infsof.2021.106600). ([ScienceDirect][7])

8. Tapia, F., Mora, M., Orozco, A. L. S., & Rodríguez, A. (2020). [From Monolithic Systems to Microservices: A Comparative Study of Performance](https://doi.org/10.3390/app10175797). ([MDPI][8])

9. Amaral, M., *et al.* (2015). [Performance Evaluation of Microservices Architectures Using Containers](https://doi.org/10.1109/NCA.2015.24). ([arXiv][9])

10. Di Francesco, P., Malavolta, I., & Lago, P. (2018). [Migrating Towards Microservice Architectures: An Industrial Survey](https://doi.org/10.1109/ICSA.2018.00012). ([ResearchGate][10])

11. Gilbert, S., & Lynch, N. (2002). [Brewer's Conjecture and the Feasibility of Consistent, Available, Partition-Tolerant Web Services](https://doi.org/10.1145/564585.564601). ([ACM Digital Library][11])

12. Garcia-Molina, H., & Salem, K. (1987). [Sagas](https://doi.org/10.1145/38713.38742). ([ACM Digital Library][12])

13. Štefanko, M. (2019). [The Saga Pattern in a Reactive Microservices Environment](https://www.scitepress.org/Papers/2019/79187/79187.pdf). ([SciTePress][13])

14. Overeem, M., Spoor, M., Jansen, S., & Brinkkemper, S. (2021). [An Empirical Characterization of Event Sourced Systems and Their Schema Evolution — Lessons from Industry](https://doi.org/10.1016/j.jss.2021.110941). ([ScienceDirect][14])

15. Sangabriel-Alarcón, J., Ocharán-Hernández, J. O., Limón, X., & Cortés-Verdín, M. K. (2024). [Domain-Driven Design in Microservices-Based Systems Development: A Systematic Literature Review and Thematic Analysis](https://doi.org/10.1134/S0361768824700749). ([SpringerLink][15])

16. Mendonça, N. C., Aderaldo, C. M., Cámara, J., & Garlan, D. (2020). [Model-Based Analysis of Microservice Resiliency Patterns](https://doi.org/10.1109/ICSA47634.2020.00019). ([ResearchGate][16])

17. Miraj, M., Zakir, M., *et al.* (2022). [Model-Based Resilience Pattern Analysis for Microservice Architecture](https://www.jatit.org/volumes/Vol100No9/30Vol100No9.pdf). ([jatit.org][17])

18. Li, B., Peng, X., Xiang, Q., *et al.* (2022). [Enjoy Your Observability: An Industrial Survey of Microservice Tracing and Analysis](https://doi.org/10.1007/s10664-021-10063-9). ([SpringerLink][18])

19. Thrivikraman, V., Dixit, V. R., Ram, N. S., *et al.* (2022). [MiSeRTrace: Kernel-Level Request Tracing for Microservice Visibility](https://doi.org/10.1145/3491204.3527462). ([arXiv][19])

20. Sedghpour, M. R. S., Klein, C., & Tordsson, J. (2022). [An Empirical Study of Service Mesh Traffic Management Policies for Microservices](https://doi.org/10.1145/3489525.3511686). ([ACM Digital Library][20])

21. Elkhatib, Y., & Povedano Poyato, J. (2023). [An Evaluation of Service Mesh Frameworks for Edge Systems](https://doi.org/10.1145/3578354.3592867). ([ACM Digital Library][21])

22. Waseem, M., Albattah, A., Hasan, M. K., *et al.* (2021). [Design, Monitoring, and Testing of Microservices Systems: The Practitioners' Perspective](https://doi.org/10.1016/j.jss.2021.111061). ([ScienceDirect][22])

23. Saman, B. (2017). [Monitoring and Analysis of Microservices Performance](https://www.researchgate.net/publication/317690568_Monitoring_and_Analysis_of_Microservices_Performance). ([ResearchGate][23])

[1]: https://research.brighton.ac.uk/en/publications/a-systematic-mapping-study-in-microservice-architecture/ "A Systematic Mapping Study in Microservice Architecture"
[2]: https://www.sciencedirect.com/science/article/pii/S0164121219300019 "Architecting with Microservices: A Systematic Mapping Study"
[3]: https://www.sciencedirect.com/science/article/abs/pii/S0164121220302053 "A Systematic Mapping Study on Microservices Architecture in DevOps"
[4]: https://www.researchgate.net/publication/323960272_Architectural_Patterns_for_Microservices_A_Systematic_Mapping_Study "Architectural Patterns for Microservices: A Systematic Mapping Study"
[5]: https://link.springer.com/chapter/10.1007/978-3-319-74781-1_15 "Towards a Taxonomy of Microservices Architectures"
[6]: https://doi.org/10.1109/MS.2018.2141030 "Microservices"
[7]: https://www.sciencedirect.com/science/article/pii/S0950584921000793 "From Monolithic Systems to Microservices: An Assessment Framework"
[8]: https://www.mdpi.com/2076-3417/10/17/5797 "From Monolithic Systems to Microservices: A Comparative Study of Performance"
[9]: https://arxiv.org/pdf/1511.02043 "Performance Evaluation of Microservices Architectures Using Containers"
[10]: https://www.researchgate.net/publication/326566575_Migrating_Towards_Microservice_Architectures_An_Industrial_Survey "Migrating Towards Microservice Architectures: An Industrial Survey"
[11]: https://dl.acm.org/doi/10.1145/564585.564601 "Brewer's Conjecture and the Feasibility of Consistent, Available, Partition-Tolerant Web Services"
[12]: https://dl.acm.org/doi/10.1145/38713.38742 "Sagas"
[13]: https://www.scitepress.org/Papers/2019/79187/79187.pdf "The Saga Pattern in a Reactive Microservices Environment"
[14]: https://www.sciencedirect.com/science/article/pii/S0164121221000674 "An Empirical Characterization of Event Sourced Systems and Their Schema Evolution"
[15]: https://link.springer.com/article/10.1134/S0361768824700749 "Domain-Driven Design in Microservices-Based Systems Development"
[16]: https://www.researchgate.net/publication/339488033_Model-Based_Analysis_of_Microservice_Resiliency_Patterns "Model-Based Analysis of Microservice Resiliency Patterns"
[17]: https://www.jatit.org/volumes/Vol100No9/30Vol100No9.pdf "Model-Based Resilience Pattern Analysis for Microservice Architecture"
[18]: https://link.springer.com/article/10.1007/s10664-021-10063-9 "Enjoy Your Observability: An Industrial Survey of Microservice Tracing and Analysis"
[19]: https://arxiv.org/abs/2203.14076 "MiSeRTrace: Kernel-Level Request Tracing for Microservice Visibility"
[20]: https://dl.acm.org/doi/10.1145/3489525.3511686 "An Empirical Study of Service Mesh Traffic Management Policies for Microservices"
[21]: https://dl.acm.org/doi/10.1145/3578354.3592867 "An Evaluation of Service Mesh Frameworks for Edge Systems"
[22]: https://www.sciencedirect.com/science/article/pii/S0164121221001436 "Design, Monitoring, and Testing of Microservices Systems: The Practitioners' Perspective"
[23]: https://www.researchgate.net/publication/317690568_Monitoring_and_Analysis_of_Microservices_Performance "Monitoring and Analysis of Microservices Performance"
