...
1. Bergstra, J., & Bengio, Y. (2012). [Random Search for Hyper-Parameter Optimization](https://www.jmlr.org/papers/v13/bergstra12a.html). ([jmlr.org][1])

2. Hazan, E., Klivans, A., & Yuan, Y. (2017). [Hyperparameter Optimization: A Spectral Approach](https://arxiv.org/abs/1706.00764). ([arXiv][2])

3. Jaderberg, M., Dalibard, V., Osindero, S., *et al.* (2017). [Population Based Training of Neural Networks](https://arxiv.org/abs/1711.09846). ([arXiv][3])

4. Li, L., Jamieson, K., DeSalvo, G., *et al.* (2018). [Hyperband: A Novel Bandit-Based Approach to Hyperparameter Optimization](https://www.jmlr.org/papers/volume18/16-558/16-558.pdf). ([arXiv][4])

5. Lorraine, J., Vicol, P., & Duvenaud, D. (2020). [Optimizing Millions of Hyperparameters by Implicit Differentiation](https://proceedings.mlr.press/v108/lorraine20a.html). ([Proceedings of Machine Learning Research][5])

6. Snoek, J., Larochelle, H., & Adams, R. P. (2012). [Practical Bayesian Optimization of Machine Learning Algorithms](https://proceedings.neurips.cc/paper/2012/file/05311655a15b75fab86956663e1819cd-Paper.pdf). ([arXiv][6])

[1]: https://jmlr.org/papers/v13/bergstra12a.html "Random Search for Hyper-Parameter Optimization"
[2]: https://arxiv.org/abs/1706.00764 "Hyperparameter Optimization: A Spectral Approach"
[3]: https://arxiv.org/abs/1711.09846 "Population Based Training of Neural Networks"
[4]: https://arxiv.org/abs/1603.06560 "Hyperband: A Novel Bandit-Based Approach to Hyperparameter Optimization"
[5]: https://proceedings.mlr.press/v108/lorraine20a.html "Optimizing Millions of Hyperparameters by Implicit Differentiation"
[6]: https://arxiv.org/abs/1206.2944 "Practical Bayesian Optimization of Machine Learning Algorithms"
