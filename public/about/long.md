...
As Chair of the London AI Working Group, I discuss and drive the implementation of AI to increase operational efficiency for the London branch. As AI Enabler for the Market Data cluster, I discuss and drive AI adoption across the whole cluster, which spans London, Frankfurt, New York and Singapore. In both roles, I deliver workshops, training sessions, and presentations, run user surveys to identify pain points, and advise teams on when to use RAG, MCP, or plain deterministic logic.
