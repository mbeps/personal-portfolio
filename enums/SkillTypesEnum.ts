 ...
 * - Hard skills: these skills are mostly technologies like specific programming languages (Python), frameworks (Next.JS), and other skills that require a lot of practice and knowledge like Calculus.
 * - General skills: these are mostly for categorising hard skills but not using specific technologies, for example Web Development, Software Engineering, and Mathematics.
