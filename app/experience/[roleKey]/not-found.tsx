...
/**
 * Route-level 404 boundary for experience roles when a roleKey is not found.
 */
  ...
  return (
    <div className="my-10 flex min-h-dvh flex-col items-center justify-center space-y-8 py-16 text-center sm:py-32 md:py-48">
      ...
      <p className="max-w-md text-neutral-600 dark:text-neutral-400">
        The experience role you are looking for does not exist or may have been
        moved.
      </p>
      <div className="flex w-full max-w-xs flex-col space-y-4">
        <Link href={ROUTES.EXPERIENCE.path} className="w-full">
