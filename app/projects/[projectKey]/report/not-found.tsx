...
/**
 * Route-level 404 boundary for project reports when a project report is not found.
 */
export default function ProjectReportNotFound() {
  return (
    <div className="my-10 flex min-h-dvh flex-col items-center justify-center space-y-8 py-16 text-center sm:py-32 md:py-48">
      ...
      <p className="max-w-md text-neutral-600 dark:text-neutral-400">
        The report for this project could not be found or has not been published
        yet.
      </p>
