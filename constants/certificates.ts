...
const cloudComputing: Certificate[] = [
  {
    ...
    tags: ["AWS", "Cloud Computing", "Amazon Web Services"],
  },
  {
  ...
  },
  {
    ...
    skills: ["Python", "Poetry", "Pytest", "PyPI"],
    tags: ["Python", "Poetry", "Pytest", "PyPI"],
  },
  {
  ...
  {
    name: "Datababase Management System (DBMS) & SQL",
...
const allCertificates = [...cloudComputing];
